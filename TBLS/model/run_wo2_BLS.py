...
from 研究生课题.集成学习与宽度学习.MBLS.model.wo2_BLS import wo2_BLS
...
def read_npy(type_name,epochs,input_dim,time_len,n_block,weight_decay,lr = 0.001):
    # 切分数据
    ...
    # 定义模型
    model = wo2_BLS(time_len=time_len,input_dim=input_dim,n_block=n_block)
    ...
    data_out.to_csv(r'C:\Users\86178\Desktop\课题\论文\MBLS\最终实验\{}\{}_wo_BLS.csv'.format(type_name,type_name))
    end_time = time.time()
...
# read_npy('lorenz',epochs = 1000,input_dim=15,time_len=5,n_block=1,weight_decay=0.02,lr = 0.0005)
# read_npy('sea_clutter',epochs = 500,input_dim=59,time_len=5,weight_decay=0.05,lr=0.0005)
read_npy('sun_spot',epochs = 500,input_dim=5,time_len=5,weight_decay=0.05,lr=0.0005,n_block=1)
